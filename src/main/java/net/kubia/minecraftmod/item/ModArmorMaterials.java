...
public enum ModArmorMaterials implements ArmorMaterial {
    JOHNNY_SINS("johnny_sins", 64, new int[]{ 100, 120, 100, 90 }, 25,
            ModSounds.JOHNNY_SINS_BLOCK_PLACE.get(), 40f, 4f, () -> Ingredient.of(ModBlocks.JOHNNY_SINS_BLOCK.get()));
    ...
    public String getName() {
        return MinecraftMod.MOD_ID + ":" + this.name;
    }
